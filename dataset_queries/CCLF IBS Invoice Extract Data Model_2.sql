SELECT 'I10' record_key_i10,
              ...
              invoice_currency_precision inv_curr_precision, -- REL-036
              ...
              from_BUC,
              tax_adn
         FROM (SELECT DISTINCT  --  start of change -- REL-050
      c.segment1 company_code, a.trx_number,a.purchase_order,a.customer_trx_id, a.operating_unit, a.bill_to_site_use_id, a.ship_to_site_use_id,
       a.invoice_currency_code, d.precision invoice_currency_precision, 
       ...
       SUBSTR(a.transaction_type,1,6) from_BUC, a.to_BUC, tax_adn,
       a.purchase_order,
   	a.buc_currency_code,
