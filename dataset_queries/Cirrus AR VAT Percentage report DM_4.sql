...
SELECT * FROM
(SELECT DISTINCT
(SELECT DISTINCT zlv.tax_rate FROM ZX_LINES_V zlv where zlv.trx_id = rcta.customer_trx_id)AS vat_rate_header1
,(SELECT description
...
'No. 87/1, Capital Tower,  All Seasons Place, 9th Floor,  Wireless Road,Lumpini, Pathumwan,  Bangkok 10330, Thailand'	 AS sender_address1
,NVL((SELECT description
		  ...
		  ,DECODE(SUBSTR((TO_CHAR(:p_start_date,'MON')),1,2),'01','JAN','02','FEB','03','MAR','04','APR','05','MAY','06','JUN','07','JUL',
					'08','AUG','09','SEP','10','OCT','11','NOV','12','DEC') ||'-'||TO_CHAR(:p_start_date,'YY') AS start_date1
		  ,DECODE(SUBSTR((TO_CHAR(:p_end_date,'MON')),1,2),'01','JAN','02','FEB','03','MAR','04','APR','05','MAY','06','JUN','07','JUL',
					'08','AUG','09','SEP','10','OCT','11','NOV','12','DEC') ||'-'||TO_CHAR(:p_end_date,'YY') AS end_date1
