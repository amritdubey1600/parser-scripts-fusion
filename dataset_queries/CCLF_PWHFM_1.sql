--# MODIFICATION HISTORY:
   ...
   --# REL-108                      Akash M                                         08-JAN-2025                      Change related to 'YWNO','YWPN' Company Codes

   --# REL-108-EMG                      Akash M                                     28-JAN-2025                      GEVRITM0146503-Wipe Out 'UC09' Company Codes  from this extract
...
WHERE a.flex_value_set_id   = b.flex_value_set_id
         ...
         AND c.language            = 'US'
                              ...
                              AND a.flex_value NOT IN ('YWNO','YWPN') -- Added for REL-108
...
AND   glc.segment1 <> 'UC09' -- Added for REL108-EMG
...
-- Added above code for REL-085
  ...
  -- Added below code for REL-108

UNION ALL

SELECT 3 extract_order, period_year||'|'||period_name||'|'||BAL_TYPE||'|'||currency_code||'|'||DECODE(segment1,'YWNO','PVN1','YWPN','DD13',segment1)||'|'||segment2||'|'||SEGMENT3
...
AND   glcc1.company_code         = glc.segment1

AND   glb.currency_code        = NVL(glcc1.functional_currency,glb.currency_code)

AND   glb.period_name = :P_PERIOD

AND   (led.name LIKE '%_'||glcc1.functional_currency||'_FCY' OR

       led.name LIKE '%_'||glcc1.functional_currency||'_PRM')
