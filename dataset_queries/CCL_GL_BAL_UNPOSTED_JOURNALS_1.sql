...
, bal.begin_balance_dr - bal.begin_balance_cr + period_net_dr - period_net_cr gl_posted_balance
...
and jel.currency_code = bal.currency_code
and bal.currency_code = l.currency_code
and jeh.period_name = bal.period_name
