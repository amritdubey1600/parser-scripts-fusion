...
SELECT 1 AS "KEY"
      ...
      ,'FTP' AS "DEL_CHANNEL"
      ,(SELECT 'CCLFGL.RECLASS.CCLJEES.SUMMARY.'||TO_CHAR(absparentID)||'.xlsx'
    ...
    WHERE
		...
		AND ( gjh.posted_date > NVL( (
                ...
                WHERE
                    ...
                    AND erh.definition = 'JobDefinition://oracle/apps/ess/custom/GL/CirrusARJournalReclassSummaryReport'
			...
			*/
            ...
            AND ( rec_line.posted_date > NVL( (
                ...
                WHERE
                    ...
                    AND ERH.executable_status = 'SUCCEEDED'
                    AND ERP1.name = 'submit.argument4'
                    --AND ERP1.value = TO_CHAR(:p_bu_name)--REL053 GERITM20414034 commented
